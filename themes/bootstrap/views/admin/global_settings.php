<p style="display:none;">This file in themes/bootstrap/views/global_settings.php</p>
<div class="col-md-12">
  ...
  <?php echo CHtml::form(array("admin/globalsettings"), 'post', array('class'=>'form form30','id'=>'frmglobalsettings','name'=>'frmglobalsettings'));?>
    ...
    <div class="tab-content">
        <div class='tab-pane active' id='overview'>
          <?php echo $this->renderPartial('/global_settings/overview', $overview); ?>
        </div>
        <div class='tab-pane' id='general'>
          <?php echo $this->renderPartial('/global_settings/general', $general); ?>
        </div>
        <div class='tab-pane' id='email'>
          <?php echo $this->renderPartial('/global_settings/email', $email); ?>
        </div>
        <div class='tab-pane' id='bounce'>
          <?php echo $this->renderPartial('/global_settings/bounce', $bounce); ?>
        </div>
        <div class='tab-pane' id='security'>
          <?php echo $this->renderPartial('/global_settings/security', $security); ?>
        </div>
        <div class='tab-pane' id='presentation'>
          <?php echo $this->renderPartial('/global_settings/presentation', $presentation); ?>
        </div>
        <div class='tab-pane' id='language'>
          <?php echo $this->renderPartial('/global_settings/language', $language); ?>
        </div>
        <div class='tab-pane' id='interfaces'>
          <?php echo $this->renderPartial('/global_settings/interfaces', $interfaces); ?>
        </div>
